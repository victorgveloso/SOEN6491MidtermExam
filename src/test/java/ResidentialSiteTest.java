...
public class ResidentialSiteTest {
	...
	private ResidentialSite _subject;
	...
	public void setUp() throws Exception {
		...
		_subject = new ResidentialSite(Registry.getInstance().getZone("A"));
	}
	...
	public void test100() {
		...
		assertEquals (new Dollars(9.19), _subject.charge());
	}
	...
	public void test99() {
		...
		assertEquals (new Dollars(9.1), _subject.charge());
	}
	...
	public void test101() {
		...
		assertEquals (new Dollars(9.28), _subject.charge());
	}
	...
	public void test200() {
		...
		assertEquals (new Dollars(18.38), _subject.charge());
	}
	...
	public void test201() {
		...
		assertEquals (new Dollars(18.47), _subject.charge());
	}
	...
	public void testMax() {
		...
		assertEquals (new Dollars(1.9730006006E8), _subject.charge());
	}
